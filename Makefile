...
example-templates:
	...
	java -jar $(JAR_PATH) generate alpha --start-date=2024-01-01 --end-date=2024-12-31 --filename target/alpha_2024.pdf
	java -jar $(JAR_PATH) generate alpha --start-date=2025-01-01 --end-date=2025-12-31 --filename target/alpha_2025.pdf
	java -jar $(JAR_PATH) generate alpha --start-date=2026-01-01 --end-date=2026-12-31 --filename target/alpha_2026.pdf
